 ...
 */
class FarbicaHija1 implements FabricaPadre {
 ...
 */
class FarbicaHija2 implements FabricaPadre {
    public createProductA(): AbstractProductA {
 ...
 */
class Producto1Hijo1 implements AbstractProductA {
    public usefulFunctionA(): string {
        return 'El resultado del producto A1.';
    }
}

class Producto2Hijo1 implements AbstractProductA {
    public usefulFunctionA(): string {
 ...
 * These Concrete Products are created by corresponding Concrete Factories.
 */
class Producto1Hijo2 implements AbstractProductB {
...
class Producto2Hijo2 implements AbstractProductB {
 ...
 */
function clientCode(factory: FabricaPadre) {
